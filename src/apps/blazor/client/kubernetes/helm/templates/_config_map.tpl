...
FSHStarterBlazorClient_ApiBaseUrl:  https://dotnetstarterkitwebapi{{ tpl .Values.configmaps.frontend.domainNameCharSeparator . }}{{ tpl .Values.configmaps.frontend.domainName . }}
